...
def superdense_coding():
    ...
    print(
    "Eve prepares Bell state, first with Hadamard gate on first qubit:")
    ...
    print(
    "Alice wants to encode two classical bits to send to Bob")
    print(
    "with only her one qubit")
    ...
    if x == 0 and y == 0:
        print(
        "For encoding 00, nothing is done (I gate is applied)")
    elif x == 0 and y == 1:
        print(
        "For encoding 01, the X (NOT) gate is applied")
        a.xgate()
    elif x == 1 and y == 0:
        print(
        "For encoding 10, the Z gate is applied")
        a.zgate()
    else:
        print(
        "For encoding 11, the X and Z gates are applied")
        a.xgate().zgate()
    ...
    print(
    "Alice sends her qubit to Bob. Now Bob has both original qubits.")

    print(
    "Bob applies a reverse operation of Eve's original operation")

    print(
    "First a controlled Not:")
    a.cnot()
    print(a)

    print(
    "Then a Hadamard on the first Qubit:")
    a.hgate()
    print(a)
    ...
    res = a.measure()
    print(
    "The result of Bob's measurement is", res, ", Alice's two bits.")
