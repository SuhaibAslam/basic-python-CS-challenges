...
def path_checker(network, user_A, user_B):
    ...
    print('This is the friend path from {0} to {1}: {2}'.format(user_A, user_B, friend_path))
    print('')
...
print('Connections of Debra:', '\n', get_connections(network, "Debra"))
print('Connections of Mercedes:', '\n', get_connections(network, "Mercedes"))
print('Games John likes:', '\n', get_games_liked(network, "John"))
print('Adding a connection between John and Freda...', '\n', add_connection(network, "John", "Freda"))
print('Adding a new user Debra...', '\n', add_new_user(network, "Debra", []))
print('Adding a new user Nick...', '\n', add_new_user(network, "Nick", ["Seven Schemers", "The Movie: The Game"]))
print('Secondary connections of Mercedes:', '\n', get_secondary_connections(network, "Mercedes"))
print('Number of common connections between John & Mercedes:', count_common_connections(network, "Mercedes", "John"))
print('Path from John to Ollie:', '\n',find_path_to_friend(network, "John", "Ollie"))
