...
def ancestors(genealogy, person):
    if person in genealogy:
        ...
        for each_parent in parents:
            parents += ancestors(genealogy, each_parent)
        return parents
    else: return []

### ERROR VERSION 1 ### (see the return statement in the for loop)
# def ancestors(genealogy, person):
#     if person in genealogy:
#         parents = genealogy[person]
#         for each_parent in parents:
#             return parents + ancestors(genealogy, each_parent)
#     else: return []

### CORRECT VERSION 2 ###
def ancestors(genealogy, person):
    if genealogy.get(person, None) != None:
        parents = genealogy.get(person)
        for each_parent in parents:
            parents += ancestors(genealogy, each_parent)
        return parents
    else: return []
...
#     ancestor_list = []
#     if genealogy.get(person, None) != None:
#         for each_parent in genealogy.get(person):
#             ancestor_list.append(ancestors(genealogy, each_parent))
